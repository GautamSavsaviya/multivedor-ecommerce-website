...
class ProductRetingReviewViewSet(viewsets.ModelViewSet):
    serializer_class = serializers.ProductRetingReviewSerializer
    queryset = models.ProductRetingReview.objects.all()